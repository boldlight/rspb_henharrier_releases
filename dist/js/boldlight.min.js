...
var beginMoment=moment("2014-09-01"),endMoment=moment(),beginDateRange=beginMoment,endDateRange=endMoment;$(window).width()<960?$(function(){$("#time").ionRangeSlider({hide_min_max:!0,keyboard:!0,min:+moment(beginMoment).format("X"),max:+moment(endMoment).format("X"),from:+moment(beginMoment).format("X"),to:+moment(endMoment).format("X"),type:"double",force_edges:!0,onFinish:function(e){beginDateRange=moment(e.from,"X").format("YYYY-MM-DD 00:00:00"),endDateRange=moment(e.to,"X").format("YYYY-MM-DD 23:59:59"),refreshTrackerMap()},prettify:function(e){return moment(e,"X").format("Do MMM YYYY")}})}):$(function(){$("#time").ionRangeSlider({hide_min_max:!0,keyboard:!0,min:+moment(beginMoment).format("X"),max:+moment(endMoment).format("X"),from:+moment(beginMoment).format("X"),to:+moment(endMoment).format("X"),type:"double",force_edges:!1,onFinish:function(e){beginDateRange=moment(e.from,"X").format("YYYY-MM-DD 00:00:00"),endDateRange=moment(e.to,"X").format("YYYY-MM-DD 23:59:59"),refreshTrackerMap()},prettify:function(e){return moment(e,"X").format("Do MMM YYYY")}})});
function tracker(e,a){this.name=e,this.isDisplayed=!1,this.live={marker:null,info:"",infoWindow:null,icon:"images/mapping/latest.png",isDisplayed:!1,datetime:""},this.polyline=null,this.points=[],this.colour=a,this.latlngbounds=new google.maps.LatLngBounds}function points_of_interest(e){this.name=e,this.isDisplayed=!1,this.markers=[],this.latlngbounds=new google.maps.LatLngBounds}function cleanName(e){return e.toLowerCase().replace(/\s+/g,"-")}function showTracker(e,a,t){var i=trackers[e];pois[e];null!=i.polyline&&i.polyline.setMap(null);var n=[];i.latlngbounds=new google.maps.LatLngBounds;for(var r=0;r<i.points.length;r++){var o=moment(i.points[r].datetime);o.isAfter(a)&&o.isBefore(t)&&(n.push(i.points[r].point),i.latlngbounds.extend(i.points[r].point))}if(n.length>0){var s=new google.maps.Polyline({path:n,strokeColor:i.colour,strokeOpacity:1,strokeWeight:3});i.polyline=s,i.polyline.setMap(map)}else i.latlngbounds=null;if(null==i.live.marker){var l=i.points[i.points.length-1],m=new google.maps.Marker({position:l.point,icon:"images/mapping/latest.png"});InfoWindow=new google.maps.InfoWindow({content:i.live.info,maxWidth:400}),bindInfoWindow(m,map,InfoWindow,i.live.info),i.live.marker=m,i.live.infoWindow=InfoWindow}i.live.isDisplayed&&i.live.marker.setMap(map),i.isDisplayed=!0,resetGlobalBounds()}function clearTracker(e){var a=trackers[e];a.polyline.setMap(null),a.live.marker.setMap(null),a.isDisplayed=!1,resetGlobalBounds()}function initializePOIs(e){var a=pois[e];a.latlngbounds=new google.maps.LatLngBounds;for(var t=0;t<a.markers.length;t++){null!=a.markers[t].marker&&a.markers[t].marker.setMap(null);var i=a.markers[t].point;a.markers[t].marker=new google.maps.Marker({position:i,icon:"images/mapping/poi.png"}),a.markers[t].infowindow=new google.maps.InfoWindow({content:a.markers[t].content,maxWidth:600}),bindInfoWindow(a.markers[t].marker,map,a.markers[t].infowindow,a.markers[t].content),a.latlngbounds.extend(i)}}function showPOI(e,a,t){for(var i=pois[e],n=0;n<i.markers.length;n++){var r=moment(i.markers[n].datetime);r.isAfter(a)&&r.isBefore(t)?i.markers[n].marker.setMap(map):i.markers[n].marker.setMap(null)}i.isDisplayed=!0,resetGlobalBounds()}function hidePOI(e){for(var a=pois[e],t=0;t<a.markers.length;t++)a.markers[t].marker.setMap(null);a.isDisplayed=!1,resetGlobalBounds()}function resetGlobalBounds(){globalbounds=new google.maps.LatLngBounds;for(var e=0;e<trackerConfig.trackers.length;e++){var a=trackers[cleanName(trackerConfig.trackers[e].name)];a.isDisplayed&&null!=a.latlngbounds&&(globalbounds.extend(new google.maps.LatLng(a.latlngbounds.getNorthEast().lat(),a.latlngbounds.getNorthEast().lng(),!0)),globalbounds.extend(new google.maps.LatLng(a.latlngbounds.getSouthWest().lat(),a.latlngbounds.getSouthWest().lng(),!0)))}if(globalbounds.isEmpty())map.setCenter({lat:parseFloat(trackerConfig.center.lat),lng:parseFloat(trackerConfig.center.lng)}),map.setZoom(trackerConfig.zoom);else{map.fitBounds(globalbounds);var t=google.maps.event.addListener(map,"idle",function(){map.getZoom()>12&&map.setZoom(12),google.maps.event.removeListener(t)})}}function refreshTrackerMap(){for(var e=0;e<trackerConfig.trackers.length;e++){var a=trackers[cleanName(trackerConfig.trackers[e].name)],t=pois[cleanName(trackerConfig.trackers[e].name)];a.isDisplayed&&showTracker(cleanName(trackerConfig.trackers[e].name),beginDateRange,endDateRange),t.isDisplayed&&showPOI(cleanName(trackerConfig.trackers[e].name),beginDateRange,endDateRange)}}function bindInfoWindow(e,a,t,i){e.addListener("click",function(){t.setContent(i),t.open(a,this)})}function showLive(e,a){var t=trackers[e];t.live.marker.setMap(map);var i=t.live.marker.getPosition();map.setCenter(i),1==a&&t.live.infoWindow.open(map,t.live.marker),t.live.isDisplayed=!0}function hideLive(e){var a=trackers[e];a.live.marker.setMap(null),a.live.isDisplayed=!1}function createInfoWindow(e){return new google.maps.InfoWindow({content:e,maxWidth:400})}function createCustomMarker(e,a){return new google.maps.Marker({position:e,icon:"images/mapping/latest.png"})}function initMap(){$(".tracker-toggle").on("click",function(e){if(e.preventDefault(),$(this).hasClass("on"))$(this).removeClass("on").siblings().removeClass("on"),clearTracker($(this).parent().attr("data-tracker")),hideLive($(this).parent().attr("data-tracker")),hidePOI($(this).parent().attr("data-tracker"));else{for(var a=0;a<trackerConfig.trackers.length;a++){var t=cleanName(trackerConfig.trackers[a].name),i=trackers[t],n=pois[t];i.live.isDisplayed&&hideLive(t),n.isDisplayed&&hidePOI(t)}$(".bird-controls .live-toggle").removeClass("on"),$(".bird-controls .poi-toggle").removeClass("on"),$(this).addClass("on"),showTracker($(this).parent().attr("data-tracker"),beginDateRange,endDateRange)}}),$(".poi-toggle").on("click",function(e){if(e.preventDefault(),$(this).hasClass("on"))hidePOI($(this).parent().attr("data-tracker")),$(this).removeClass("on");else{var a=!1;$(this).siblings(".live-toggle").hasClass("on")&&(a=!0);for(var t=0;t<trackerConfig.trackers.length;t++){var i=cleanName(trackerConfig.trackers[t].name),n=trackers[i],r=pois[i];n.isDisplayed&&clearTracker(i),n.live.isDisplayed&&hideLive(i),r.isDisplayed&&hidePOI(i)}$(".bird-controls .btn").removeClass("on"),$(this).addClass("on"),$(this).siblings(".tracker-toggle").addClass("on"),1==a&&$(this).siblings(".live-toggle").addClass("on"),0==trackers[$(this).parent().attr("data-tracker")].isDisplayed&&showTracker($(this).parent().attr("data-tracker"),beginDateRange,endDateRange),showPOI($(this).parent().attr("data-tracker"),beginDateRange,endDateRange),1==a&&showLive($(this).parent().attr("data-tracker"),!1)}}),$(".live-toggle").on("click",function(e){if(e.preventDefault(),$(this).hasClass("on"))hideLive($(this).parent().attr("data-tracker")),$(this).removeClass("on");else{var a=!1;$(this).siblings(".poi-toggle").hasClass("on")&&(a=!0);for(var t=0;t<trackerConfig.trackers.length;t++){var i=cleanName(trackerConfig.trackers[t].name),n=trackers[i],r=pois[i];n.isDisplayed&&clearTracker(i),n.live.isDisplayed&&hideLive(i),r.isDisplayed&&hidePOI(i)}$(".bird-controls .btn").removeClass("on"),$(this).addClass("on"),$(this).siblings(".tracker-toggle").addClass("on"),1==a&&$(this).siblings(".poi-toggle").addClass("on"),0==trackers[$(this).parent().attr("data-tracker")].isDisplayed&&showTracker($(this).parent().attr("data-tracker"),beginDateRange,endDateRange),showLive($(this).parent().attr("data-tracker"),!1),1==a&&showPOI($(this).parent().attr("data-tracker"),beginDateRange,endDateRange)}}),map=new google.maps.Map(document.getElementById("map"),{zoom:trackerConfig.zoom,fullscreenControl:!1,streetViewControl:!1,mapTypeControl:!1,zoomControl:!1,scrollwheel:!1,navigationControl:!1,scaleControl:!1,disableDoubleClickZoom:!0,TiltGestures:!1,AllGestures:!1,ZoomGestures:!1,ScrollGestures:!1,zoomControlOptions:{position:google.maps.ControlPosition.RIGHT_TOP},center:{lat:parseFloat(trackerConfig.center.lat),lng:parseFloat(trackerConfig.center.lng)},styles:[{featureType:"administrative",elementType:"labels.text.fill",stylers:[{color:"#444444"}]},{featureType:"administrative.locality",elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"landscape",elementType:"all",stylers:[{color:"#f2f2f2"},{visibility:"simplified"}]},{featureType:"poi",elementType:"all",stylers:[{visibility:"on"}]},{featureType:"poi",elementType:"geometry",stylers:[{visibility:"simplified"},{saturation:"-65"},{lightness:"45"},{gamma:"1.78"}]},{featureType:"poi",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"poi",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"road",elementType:"all",stylers:[{saturation:-100},{lightness:45}]},{featureType:"road",elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"road",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"road.highway",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"road.highway",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"road.arterial",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"transit.line",elementType:"geometry",stylers:[{saturation:"-33"},{lightness:"22"},{gamma:"2.08"}]},{featureType:"transit.station.airport",elementType:"geometry",stylers:[{gamma:"2.08"},{hue:"#ffa200"}]},{featureType:"transit.station.airport",elementType:"labels",stylers:[{visibility:"off"}]},{featureType:"transit.station.rail",elementType:"labels.text",stylers:[{visibility:"off"}]},{featureType:"transit.station.rail",elementType:"labels.icon",stylers:[{visibility:"simplified"},{saturation:"-55"},{lightness:"-2"},{gamma:"1.88"},{hue:"#ffab00"}]},{featureType:"water",elementType:"all",stylers:[{color:"#bbd9e5"},{visibility:"simplified"}]}]}),globalbounds=new google.maps.LatLngBounds,map.addListener("zoom_changed",function(){map.getZoom()>8&&map.setZoom(8)});for(e=0;e<trackerConfig.trackers.length;e++)trackers[cleanName(trackerConfig.trackers[e].name)]=new tracker(trackerConfig.trackers[e].name,trackerConfig.trackers[e].colour,trackerConfig.trackers[e].icon);for(var e=0;e<poiConfig.pois.length;e++)pois[cleanName(poiConfig.pois[e].name)]=new points_of_interest(poiConfig.pois[e].name);$.ajax({url:"data/data.xml",async:!1}).done(function(e){$(e).find("placemark").each(function(){var e=cleanName($(this).find("name").text()),a=trackers[e],t=$(this).find("X").text(),i=$(this).find("Y").text(),n=new google.maps.LatLng(t,i,!0),r=$(this).find("date_time").text();datetime_formatted=moment(r).format("D MMMM YYYY"),a.points.push({point:n,datetime:$(this).find("date_time").text()});var o='<div class="latest-info"><p class="datetime">'+datetime_formatted+'</div><div class="latest-info-text">'+$(this).find("latest_position").text()+"</div></div>";a.live.info=o,a.live.datetime=$(this).find("date_time").text()})}),$.ajax({url:"data/poi.xml",async:!1}).done(function(e){$(e).find("marker").each(function(){var e=cleanName($(this).find("name").text()),a=pois[e],t=$(this).find("X").text(),i=$(this).find("Y").text(),n=$(this).find("date_time").text(),r=$(this).find("media").text(),o=$(this).find("title").text(),s=$(this).find("text").text(),l=$(this).find("link").text(),m=$(this).find("button_text").text(),c=new google.maps.LatLng(t,i,!0),d='<div class="poi-info">',p=/iframe/.test(r);p?d+='<div class="video-container">'+r+"</div>":p||""==r||(d+='<div class="image-surround">'+r+"</div>"),""!=o&&(d+="<h3>"+o+"</h3>"),""!=n&&(datetime_formatted=moment(n).format("D MMMM YYYY"),d+='<p class="datetime">'+datetime_formatted+"</p>"),""!=s&&(d+='<p class="text">'+s+"</p>"),""!=l&&""!=m&&(d+='<p class="link"><a target="_blank" href="'+l+'">'+m+"</a></p>"),d+="</div>",a.markers.push({point:c,datetime:n,content:d})})}),initializePOIs("deecee"),initializePOIs("wendy"),initializePOIs("harriet"),initializePOIs("finn"),initializePOIs("aalin"),initializePOIs("chance"),initializePOIs("holly"),initializePOIs("elwood"),initializePOIs("carroll"),initializePOIs("bonny"),initializePOIs("beater"),initializePOIs("donald"),initializePOIs("hermione"),initializePOIs("calluna"),initializePOIs("heather"),initializePOIs("eric"),initializePOIs("skylar"),initializePOIs("saorsa"),initializePOIs("sirius"),initializePOIs("lia"),initializePOIs("rannoch"),initializePOIs("tony"),initializePOIs("manu"),initializePOIs("arthur"),initializePOIs("keen"),initializePOIs("mairie"),initializePOIs("marci"),initializePOIs("nyx"),initializePOIs("rain"),initializePOIs("thoth"),initializePOIs("vulcan"),showTracker("arthur",beginDateRange,endDateRange),showLive("arthur",!1),showPOI("arthur",beginDateRange,endDateRange)}var trackers=[],pois=[],usualRoute=[],map,globalbounds,Red="#e6194b",Green="#3cb44b",Yellow="#ffe119",Deep_blue="#0082c8",Orange="#f58231",Purple="#911eb4",Cyan="#46f0f0",Magenta="#f032e6",Lime="#d2f53c",Pink="#fabebe",Teal="#008080",Lavender="#e6beff",Brown="#aa6e28",Beige="#fffac8",Maroon="#800000",Mint="#aaffc3",Olive="#808000",Coral="#ffd8b1",Navy="#000080",Grey="#808080",Black="#000000",Petrol="#0d9896",Burnt_orange="#983505",Salmon="#de7264",Gold="#ba9640",Red18="#855A5A",Olive18="#879962",Blue18="#59818D",Purple18="#674C74",Lavender18="#9C6D94",Mint18="#83C098",Salmon18="#CFA2A2",Grey18="#8F8F8F",trackerConfig={trackers:[{name:"Aalin",colour:Olive},{name:"Arthur",colour:Green},{name:"Beater",colour:Yellow},{name:"Bonny",colour:Deep_blue},{name:"Calluna",colour:Orange},{name:"Carroll",colour:Purple},{name:"Chance",colour:Cyan},{name:"Deecee",colour:Magenta},{name:"Donald",colour:Lime},{name:"Elwood",colour:Pink},{name:"Eric",colour:Teal},{name:"Finn",colour:Olive18},{name:"Harriet",colour:Brown},{name:"Heather",colour:Beige},{name:"Hermione",colour:Maroon},{name:"Holly",colour:Mint},{name:"Keen",colour:Red},{name:"Lia",colour:Coral},{name:"Mairie",colour:Navy},{name:"Manu",colour:Grey},{name:"Marci",colour:Black},{name:"Nyx",colour:Petrol},{name:"Rain",colour:Burnt_orange},{name:"Rannoch",colour:Salmon},{name:"Saorsa",colour:Gold},{name:"Sirius",colour:Red18},{name:"Skylar",colour:Lavender},{name:"Thoth",colour:Blue18},{name:"Tony",colour:Purple18},{name:"Vulcan",colour:Mint18},{name:"Wendy",colour:Salmon18}],center:{lat:"54.356536",lng:"-4.458614"},zoom:6},poiConfig={pois:[{name:"Deecee"},{name:"Wendy"},{name:"Harriet"},{name:"Finn"},{name:"Aalin"},{name:"Chance"},{name:"Holly"},{name:"Elwood"},{name:"Carroll"},{name:"Bonny"},{name:"Beater"},{name:"Donald"},{name:"Hermione"},{name:"Calluna"},{name:"Heather"},{name:"Eric"},{name:"Skylar"},{name:"Saorsa"},{name:"Sirius"},{name:"Lia"},{name:"Rannoch"},{name:"Tony"},{name:"Manu"},{name:"Arthur"},{name:"Keen"},{name:"Mairie"},{name:"Marci"},{name:"Nyx"},{name:"Rain"},{name:"Thoth"},{name:"Vulcan"}]},infowindow;
$(document).ready(function(){$(window).width()<960&&($(".map-controls").hide(),$(".map-controls-open").hide(),$(".map-controls-closed").show()),$(".map-controls-open a").click(function(o){o.preventDefault(),$(".map-controls").slideUp(),$(".map-controls-open").hide(),$(".map-controls-closed").show()}),$(".map-controls-closed a").click(function(o){o.preventDefault(),$(".map-controls").slideDown(),$(".map-controls-open").show(),$(".map-controls-closed").hide()}),$(".year-filter a").click(function(o){o.preventDefault(),$(".year-filter a").removeClass("on"),$(this).addClass("on");var t=$(this).attr("rel");$("#"+t).show().siblings(".year-group").hide()}),$("#spa-button").click(function(){$("#spa-map").slideToggle("fast",function(){$("#spa-map").is(":visible")?$("#spa-button .button__text").html("Hide the map"):$("#spa-button .button__text").html("Show the map")})})});